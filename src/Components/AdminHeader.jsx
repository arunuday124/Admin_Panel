...
const AdminHeader = ({ toggleSidebar, isSidebarOpen }) => {
  return (
    <header className="fixed top-0 left-0 right-0 h-16 bg-black text-white shadow-lg z-50">
      <div className="h-full px-4 flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          ...
          <h1 className="text-xl font-bold">FoodBNB Admin Dashboard</h1>
        </div>
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="hidden md:block">
            <input
              ...
              className="px-4 py-2 rounded-lg bg-white/20 backdrop-blur-sm text-white placeholder-white/70 border border-white/30 focus:outline-none focus:ring-2 focus:ring-white/50"
            />
          </div>
